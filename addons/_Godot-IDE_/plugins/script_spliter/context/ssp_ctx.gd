...
const PLUS_SPLIT = preload("res://addons/_Godot-IDE_/plugins/script_spliter/context/icons/plus_split.svg")
const MINUS_SPLIT = preload("res://addons/_Godot-IDE_/plugins/script_spliter/context/icons/minus_split.svg")
const SspEditor = preload("res://addons/_Godot-IDE_/plugins/script_spliter/context/ssp_editor.gd")
...
func _out_sub_split(__ : Variant = null) -> void:
	var sc : ScriptEditor = EditorInterface.get_script_editor()
	var ed : ScriptEditorBase = sc.get_current_editor()
	var be : Control = ed.get_base_editor()
